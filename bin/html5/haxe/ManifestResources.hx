...
@:keep @:bind #if display private #end class __ASSET__data_graphics_wire_sheet_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:image("data/graphics/wire_sheet.png") #if display private #end class __ASSET__data_graphics_wire_sheet_png extends lime.graphics.Image {}
